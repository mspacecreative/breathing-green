...
<?php ob_start(); ?>
			...
			?>
				<div class="logo_container">
					...
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="<?php echo get_stylesheet_directory_uri() ?>/img/logo/breathing-green-logo.png" id="logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
					<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
						<img src="<?php echo get_stylesheet_directory_uri() ?>/img/logo/breathing-green-wordmark.png" class="scroll-logo" data-height-percentage="<?php echo esc_attr( et_get_option( 'logo_height', '54' ) ); ?>" />
					</a>
				</div>
			<?php
		...
		<?php echo get_template_part('includes/login-form'); ?>
	<?php
